...
<div class="flex flex-col items-center justify-center min-h-screen p-4">
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-7xl">
        <h2 class="text-2xl font-semibold text-blue-900 mb-6 text-center">Laporan Data Alumni</h2>

        <!-- <div class="flex items-center justify-between mb-6">
            <form action="{{ route('alumni_data.index') }}" method="GET" class="w-full max-w-lg flex items-center bg-blue-500 rounded-full overflow-hidden shadow-md">
                ...
                <tbody>
                    @forelse ($alumnis as $alumni)
                        <tr class="bg-white border-b hover:bg-gray-50">
                            ...
                            <td class="py-4 px-6">
                                <a href="{{ route('alumni_data.show', $alumni->id) }}" class="font-medium text-blue-600 hover:underline">Lihat</a>
                            </td>
                        </tr>
                    @empty
